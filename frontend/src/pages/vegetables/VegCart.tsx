                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-zinc-500 font-light">
                      ₹{item.product.price} <span className="text-[10px] uppercase tracking-widest ml-2 opacity-50">per unit</span>
                    </p>
                  </div>
                  ...
                  <div className="flex items-center gap-3 bg-zinc-100 dark:bg-white/5 rounded-xl p-1 border border-zinc-200 dark:border-white/10">
                    ...
                    <button
                      onClick={() => updateQuantity(item.product.id, item.quantity + 1)}
                      className="w-8 h-8 flex items-center justify-center text-emerald-600 hover:bg-emerald-500 hover:text-white rounded-lg transition-all"
                    >
                      <Plus size={14} />
                    </button>
                  </div>
            ...
            <div className="bg-white dark:bg-white/5 rounded-3xl border border-zinc-100 dark:border-white/10 p-8 shadow-2xl shadow-black/5">
              <div className="flex justify-between items-center mb-8 pb-8 border-b border-zinc-100 dark:border-white/5">
                <div className="flex flex-col">
                  <span className="text-sm text-zinc-400 uppercase tracking-widest font-medium">Grand Total</span>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={() => navigate('/vegetables/checkout')}
